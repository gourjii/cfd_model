...
echo -e "${BLUE}=== CFD Unsteady Simulation with Matplotlib ===${NC}"
...
echo -e "  • View single frame: ${BLUE}python matplotlib_cfd_viewer.py --frame N${NC}"
echo -e "  • Create new animation: ${BLUE}python matplotlib_cfd_viewer.py --animate${NC}"
echo -e "  • Save all frames: ${BLUE}python matplotlib_cfd_viewer.py --save-frames${NC}"
echo -e ""
